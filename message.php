              ...
              $email = $arry['email'];
                   ...
                   if(empty($_POST)===false){
                     ...
                     if(empty($phoneno) || empty($subject) || empty($complain)){
                       ...
                       mysql_query("INSERT INTO `cmp_log` VALUES ('0','$id','$name','$nsu_id','$email','$phoneno','$subject','$complain','$ref')") or die(mysql_error());
            ...
            <div class="container">
              ...
              <table>
                ...
                <tr>
                  ...
                  <td><select class="select" multiple data-mdb-clear-button="true">
